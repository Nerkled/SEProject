...
public final class DataStoreGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<main.proto.UserToComputeProto.GetDataRequest,
      main.proto.UserToComputeProto.GetDataResponse> getCreateLucasServerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createLucasServer",
      requestType = main.proto.UserToComputeProto.GetDataRequest.class,
      responseType = main.proto.UserToComputeProto.GetDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<main.proto.UserToComputeProto.GetDataRequest,
      main.proto.UserToComputeProto.GetDataResponse> getCreateLucasServerMethod() {
    io.grpc.MethodDescriptor<main.proto.UserToComputeProto.GetDataRequest, main.proto.UserToComputeProto.GetDataResponse> getCreateLucasServerMethod;
    if ((getCreateLucasServerMethod = DataStoreGrpc.getCreateLucasServerMethod) == null) {
      synchronized (DataStoreGrpc.class) {
        if ((getCreateLucasServerMethod = DataStoreGrpc.getCreateLucasServerMethod) == null) {
          DataStoreGrpc.getCreateLucasServerMethod = getCreateLucasServerMethod =
              io.grpc.MethodDescriptor.<main.proto.UserToComputeProto.GetDataRequest, main.proto.UserToComputeProto.GetDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createLucasServer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  main.proto.UserToComputeProto.GetDataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  main.proto.UserToComputeProto.GetDataResponse.getDefaultInstance()))
              .setSchemaDescriptor(new DataStoreMethodDescriptorSupplier("createLucasServer"))
              .build();
        }
      }
    }
    return getCreateLucasServerMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createLucasServer(main.proto.UserToComputeProto.GetDataRequest request,
        io.grpc.stub.StreamObserver<main.proto.UserToComputeProto.GetDataResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateLucasServerMethod(), responseObserver);
    }
  }
  ...
  public static final class DataStoreStub
    ...
    /**
     */
    public void createLucasServer(main.proto.UserToComputeProto.GetDataRequest request,
        io.grpc.stub.StreamObserver<main.proto.UserToComputeProto.GetDataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateLucasServerMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class DataStoreBlockingStub
    ...
    /**
     */
    public main.proto.UserToComputeProto.GetDataResponse getData(main.proto.UserToComputeProto.GetDataRequest request) {
    ...
    /**
     */
    public main.proto.UserToComputeProto.GetDataResponse createLucasServer(main.proto.UserToComputeProto.GetDataRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getCreateLucasServerMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class DataStoreFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<main.proto.UserToComputeProto.GetDataResponse> createLucasServer(
        main.proto.UserToComputeProto.GetDataRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getCreateLucasServerMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_DATA = 0;
  private static final int METHODID_STORE_DATA = 1;
  private static final int METHODID_CREATE_LUCAS_SERVER = 2;
      ...
      switch (methodId) {
        ...
        case METHODID_STORE_DATA:
          serviceImpl.storeData((main.proto.UserToComputeProto.StoreDataRequest) request,
              (io.grpc.stub.StreamObserver<main.proto.UserToComputeProto.StoreDataResponse>) responseObserver);
          break;
        case METHODID_CREATE_LUCAS_SERVER:
          serviceImpl.createLucasServer((main.proto.UserToComputeProto.GetDataRequest) request,
              (io.grpc.stub.StreamObserver<main.proto.UserToComputeProto.GetDataResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          getCreateLucasServerMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              main.proto.UserToComputeProto.GetDataRequest,
              main.proto.UserToComputeProto.GetDataResponse>(
                service, METHODID_CREATE_LUCAS_SERVER)))
        .build();
  }
      ...
      synchronized (DataStoreGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getCreateLucasServerMethod())
              .build();
        }
      }
    }
